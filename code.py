...
def play_music(name):
    ...
    IPython.display.Audio("/content/drive/MyDrive/music/music.mp3")


home = input("what would you like me to call u? ")
while True:
    want = input(f"hey {home} what can i do to help u?(type help to know what i can do ) ")
    ...
    if want == "riddle" or want == "Riddle" or want == "RIDDLE":
            ...
            print("the  fillowing can be done by using the give key words \n music:to chill out on some music \n riddle: to see if you can get it right \n joke:to laugh out some stress \n calculator: to calculate any numbers \n timer:to set a timer for how many ever seconds \n nick name:to change your nick name \n game:to play some games ")
